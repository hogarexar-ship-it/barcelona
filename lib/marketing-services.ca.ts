...
export const marketingServicesCa: MarketingService[] = [
  {
    ...
    oneLiner: "Arriba a usuaris que estiguin buscant els teus serveis i aconsegueix que et truquin.",
  ...
  },
  {
    ...
    oneLiner: "La cara visible del teu negoci, optimitzada per a un accés i conversió ràpids.",
  ...
  },
  {
    ...
    icon: "mapPin",
    name: "Google Business (Maps i Ressenyes)",
    tag: "Google Maps",
    title: "Surt al mapa de Google amb bones ressenyes",
    oneLiner: "Posiciona't millor al mapa i aconsegueix més ressenyes.",
