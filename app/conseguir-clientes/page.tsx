...
const description = `Únete gratis a la red de ${siteConfig.brand}: te pasamos clientes de reformas, fontanería y electricidad en tu zona de Barcelona y pagas comisión solo por los trabajos que cierras.`;
  ...
  return (
    <>
      ...
      <div className="bg-cream-100 pt-6">
        <Container>
          <Breadcrumbs items={[{ name: networkOffer.name, href: path }]} />
        </Container>
      </div>
      ...
      <PageHero
        ...
        actions={
          <>
            <PrimaryCta href="/empezar?interes=clientes" label={networkOffer.cta} />
            <WhatsAppButton />
          </>
        }
      />
      ...
      <section className="py-16 sm:py-24">
        <Container className="grid gap-10 lg:grid-cols-2">
          ...
          <div className="rounded-xl2 bg-ink-900 p-7 text-white sm:p-9">
            <p className="text-sm font-semibold uppercase tracking-wide text-terracotta-300">¿Y si además quieres tu propia marca?</p>
