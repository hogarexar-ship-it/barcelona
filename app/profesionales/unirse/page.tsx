...
import { commercialTerms, proWhatsappMessage, siteConfig, telHref, whatsappHref } from "@/lib/site-config";

export const metadata: Metadata = buildMetadata({
  title: "Únete a la red: más clientes para fontaneros y electricistas",
  description: `Cuéntanos sobre tu negocio de fontanería o electricidad en Barcelona y te llamamos para ver cómo conseguirte más clientes. ${commercialTerms.network.signupFee}, sin compromiso.`,
  path: proRoutes.join,
});
      ...
      <Container>
        <Breadcrumbs
          items={[
            ...
            { name: "Unirse", href: proRoutes.join },
          ]}
        />
            ...
            <div className="mt-10 rounded-xl2 border border-ink-100 bg-white p-6 text-sm text-ink-600">
              ...
              <ul className="mt-3 space-y-2">
                <li>
                  WhatsApp:{" "}
                  <a
                    href={whatsappHref(proWhatsappMessage)}
                    target="_blank"
                ...
                <li>
                  Email:{" "}
                  <a href={`mailto:${siteConfig.email}`} className="font-semibold text-accent-600 underline underline-offset-4">
                    {siteConfig.email}
                  </a>
                </li>
